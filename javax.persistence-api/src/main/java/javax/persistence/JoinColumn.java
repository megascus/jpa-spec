...
public @interface JoinColumn {
     ...
     * 参照元の関係プロパティの名前または参照元のエンティティまたは埋め込み可能クラスのフィールド + "_" + 参照される主キーのカラムの名前
     * <br>
     * エンティティにそのような参照関係プロパティまたはフィールドがない場合、もしくは要素コレクションの結合である場合、結合カラム名は次のようになります。 
     ...
     * <ul>
     * <li> ここで説明するケース以外のエンティティ関係マッピングで使用する場合、参照先のカラムはターゲットエンティティのテーブルにあります。
