...
public @interface MapKeyColumn {
     ...
     * ManyToManyのエンティティ関係や結合テーブルを使用したOneToManyのエンティティ関係のためのマップキーの場合、マップキーのカラムは結合テーブルに存在します。
     * 外部キーマッピング戦略を使用したOneToManyのエンティティ関係のためのマップキーの場合、マップキーのカラムは値がマッピングされたテーブルに存在します。
