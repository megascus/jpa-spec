 ...
 * 
 * <p> このインタフェースのメソッドは、この永続化ユニットまたは新しいエンティティインスタンスのエンティティマネージャから取得または管理されたエンティティインスタンスに対してのみ呼び出す必要があります。
 * <code>PersistenceUtil</code>インターフェースのインスタンスは{@link Persistence}クラスから得られ、エンティティが作成された環境の永続化プロバイダに関係なくエンティティやエンティティの属性のロード状態を測定するために使用されます。
 *
