...
public interface AttributeConverter<X,Y> {
     ...
     * @return  データベースのカラムに格納するために変換されたデータ
     */
     ...
     * 
     * JDBCドライバによって使用される対応するカラムの<code>dbData</code>の正しい型を指定するのはコンバーターライターの責任であることに注意してください。
     * つまり、永続化プロバイダがそのような型変換を行うことは期待されません。
     *
     * @param dbData  変換されるデータベースのカラムからのデータ
