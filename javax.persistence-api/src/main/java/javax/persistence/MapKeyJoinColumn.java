...
public @interface MapKeyJoinColumn {
     ...
     * <li> ManyToManyのエンティティ関係や結合テーブルを使用したOneToManyのエンティティ関係の結合の場合、外部キーのカラムは結合テーブルに存在します。
     * <li> 外部キーマッピング戦略を使用したOneToManyのエンティティ関係の結合の場合、マップキーのための外部キーのカラムは(Mapの)値がマッピングされたテーブルに存在します。
     * </ul>
     *
